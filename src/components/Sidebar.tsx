...
export const Sidebar: React.FC = () => {
    ...
    const handleChangeProjectIcon = (e: React.MouseEvent, project: Project) => {
        ...
        openModal({
            ...
            options: {
                'Status & Priority': ['🔴', '🟠', '🟡', '🟢', '🔵', '🟣', '🟤', '⚫', '⚪', '🟥', '🟧', '🟨', '🟩', '🟦', '🟪', '🟫', '⬛', '⬜', '🔳', '🔲', '▪️', '▫️', '◾', '◽', '◼️', '◻️', '🔶', '🔷', '🔸', '🔹', '🔺', '🔻', '💠', '🔘', '☑️', '✅', '✔️', '❌', '❎'],
                'Progress & Signs': ['➕', '➖', '➗', '✖️', '♾️', '💲', '💱', '™️', '©️', '®️', '〽️', '‼️', '⁉️', '❗', '❓', '❕', '❔', '⭕', '💯', '💢', '♨️', '🛑', '⛔', '📛', '🚫', '⚠️', '🚸', '🔱', '⚜️', '🔰', '♻️', '💹', '❇️', '✳️', '🌐', 'Ⓜ️', '🏧', '🚮', '🚰', '♿', '🚹', '🚺', '🚻', '🚼', '🚾', '🛂', '🛃', '🛄', '🛅'],
                'Work & Finance': ['💼', '👜', '👛', '👓', '🕶️', '🥽', '🥼', '🦺', '👔', '👕', '👖', '🧣', '🧤', '🧦', '👗', '👘', '🥻', '🩱', '🩲', '🩳', '👙', '👠', '👡', '👢', '👞', '👟', '🥾', '🥿', '🧢', '👒', '🎩', '🎓', '👑', '⛑️', '💍', '💎', '🔇', '🔈', '🔉', '🔊', '📢', '📣', '📯', '🔔', '🔕'],
                'Abstract & Concepts': ['💭', '🗯️', '💬', '🗨️', '👁️‍🗨️', '💤', '💥', '💦', '💨', '💫', '🔥', '✨', '🌟', '⭐', '☀️', '⚡', '☄️', '💧', '🌊', '❄️', '☃️', '⛄', '🌬️', '🌀', '🌈', '🌂', '☂️', '☔', '⛱️'],
                'Software & Tech': ['💻', '🖥️', '💾', '💿', '⌨️', '🖱️', '🌐', '📱', '📲', '🔋', '🔌', '📡', '🛰️', '🤖', '👾', '🐛', '🧬', '🔐', '🔒', '🔓', '🔍', '🔎', '📧', '📨', '📩', '📤', '📥', '📦', '🏷️', '☁️', '🌩️'],
                'Engineering & Tools': ['⚙️', '🔧', '🛠️', '🔩', '🏗️', '📐', '📏', '🧰', '⛏️', '🔨', '⚒️', '🧱', '⛓️', '🧲', '🪜', '🪝', '🧪', '🔬', '🔭', '⚗️', '🚢', '🚄', '🚅', '🚇', '🚌', '🚛', '🚜'],
                'Verification & QA': ['✅', '☑️', '✔️', '❌', '❎', '📋', '📊', '📈', '📉', '🐞', '🩹', '🛡️', '💊', '💉', '🩺', '📑', '🧾', '🗒️', '🗓️', '📆', '📅', '📇', '🗃️', '🗄️', '📁', '📂', '🗂️', '📌', '📍', '📎', '🖇️', '🖊️', '📝', '🗑️'],
                'Activity & Objects': ['🚀', '🎨', '📱', '💻', '📊', '🔥', '🔮', '⚡', '💎', '🌈', '🏗️', '🤖', '🎮', '🎧', '📷', '📚', '💡', '🛠️', '🌍', '🏠', '🎓', '🏆', '🎯', '🎪', '🎭', '🎬', '🎤', '🎹', '🎷', '🎸', '🎺', '🎻', '🎼', '🧩', '🎲', '🎰', '🎳', '🎱', '🏀', '🏈', '🎾'],
                'Nature': ['🌲', '🌳', '🌴', '🌵', '🌷', '🌸', '🌹', '🌺', '🌻', '🌼', '🌽', '🌾', '🌿', '🍀', '🍁', '🍂', '🍃', '🍄', '🌰', '🦀', '🦞', '🦐', '🦑'],
                'Food': ['🍏', '🍎', '🍐', '🍊', '🍋', '🍌', '🍉', '🍇', '🍓', '🍈', '🍒', '🍑', '🥭', '🍍', '🥥', '🥝', '🍅', '🍆', '🥑', '🥦', '🥬', '🥒', '🌶️'],
